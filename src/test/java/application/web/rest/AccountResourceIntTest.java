...
import application.WorldwideApp;
import application.domain.Authority;
import application.domain.PersistentToken;
import application.domain.User;
import application.repository.AuthorityRepository;
import application.repository.PersistentTokenRepository;
import application.repository.UserRepository;
import application.security.AuthoritiesConstants;
import application.service.MailService;
import application.service.UserService;
import application.service.dto.UserDTO;
import application.web.rest.vm.KeyAndPasswordVM;
import application.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = WorldwideApp.class)
